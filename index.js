...
console.log("greatest increase in profit/losses:", greatestincrease, "on", greatestincreasedate);
...
for (let i = 1; i < financialData.length; i++) {
  let currentvalue = financialData[i][1];
  let previousvalue = financialData[i - 1][1];
  let decrease = currentvalue - previousvalue;
  if (decrease < greatestdecrease) {
    greatestdecrease = decrease;
    greatestdecreasedate = financialData[i][0];
  }
}
console.log("greatest decrease in profit/losses:", greatestdecrease, "on", greatestdecreasedate);



let totalsum = 0;
for (let i = 0; i < financialData.length; i++) { totalsum += financialData[i][1]; }
console.log("total sum of financial data:", totalsum);
